  ...
  (<blockquote class='instagram-media' data-instgrm-captioned data-instgrm-version='6' style=' background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);'>
    <div style='padding:8px;'>{' '}
      ...
      <p style=' color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;'>
        {postedBy({user})} on {postedAt({date})}
      </p>
    </div>
  </blockquote>);
  ...
  (<blockquote class='instagram-media' data-instgrm-version='6' style=' background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:658px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);'>
    <div style='padding:8px;'>{' '}
      ...
      <p style=' color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;'>
        ...
        {postedBy({user})}</a> on {postedAt({date})}
      </p>
    </div>
  </blockquote>);
...
function postedBy ({user}) {
  ...
  return `A photo posted by ${user.name} (@${user.slug})`;
}
...
function postedAt ({date}) {
  ...
  return (<time style=' font-family:Arial,sans-serif; font-size:14px; line-height:17px;' datetime={date.utc}>{date.string}</time>);
}
